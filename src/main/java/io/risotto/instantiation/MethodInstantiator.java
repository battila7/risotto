 ...
 * io.risotto.annotations.BindingSupplier} annotation. By convention binding supplier methods should
 * return a new instance of their return type on each invocation. Method parameters are detected and
